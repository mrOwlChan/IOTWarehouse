                                ...
                                <div class="col-md-5 pl-3">
                                    <div class="row mb-4">
                                        <div class="col-md-12">
                                            ...
                                            <input type="text" class="form-control form-control-sm mt-1" placeholder="{{ $user->name }}" name="name" id="name" value="{{ $user->name, old('name') }}" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-md-12">
                                            ...
                                            <input type="email" class="form-control form-control-sm mt-1" placeholder="{{ $user->email }}" name="email" id="email" value="{{ $user->email, old('email') }}" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-md-12">
                                            ...
                                            <input type="text" class="form-control form-control-sm mt-1" placeholder="{{ $user->phone }}" name="phone" id="phone" value="{{ $user->phone, old('phone') }}" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-md-6">
                                            ...
                                            <input type="date" class="form-control form-control-sm mt-1" placeholder="{{ $user->birth_date }}" name="birth_date" id="birth_date" value="{{ $user->birth_date->format('Y-m-d'), old('birth_date') }}" required>
                                        </div>
                                        <div class="col-md-6">
                                            <strong><i class="fas fa-map-marked mr-1"></i> Birth City</strong>
                                            <input type="text" class="form-control form-control-sm mt-1" placeholder="{{ $user->birth_city }}" name="birth_city" id="birth_city" value="{{ $user->birth_city, old('birth_city') }}" required>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-5">        
                                    <div class="row mb-4">
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group">
                                                <select class="custom-select custom-select-sm mt-1" name="province" id="province" value={{ old('province') }}  aria-label="" required>
                                                    @if ($user->city->province->name != null || $user->city->province->name != '')
                                                        <option value="{{ $user->city->province->province_code }}" selected>{{ $user->city->province->name }}</option>
                                                    @endif
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group">
                                                <select class="custom-select custom-select-sm mt-1" name="city" id="city" aria-label="" required>
                                                    @if ($user->city->name != null || $user->city->name != '')
                                                        <option value="{{ $user->city->id }}" selected>{{ $user->city->name }} /{{ $user->city->type }}</option>
                                                    @endif
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control form-control-sm mt-1" name="subdistrict" id="subdistrict" value="{{ $user->subdistrict->name,old('subdistrict') }}" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <strong><i class="fas fa-map-marked mr-1"></i> Urban Village</strong>
                                            <div class="input-group">
                                                <input type="text" class="form-control form-control-sm mt-1" name="urban_village" id="urban_village" value="{{ $user->urban_village->name ,old('urban_village') }}" required>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control form-control-sm mt-1" name="urban_village_postal" id="urban_village_postal" value="{{ $user->urban_village->urban_village_code, old('urban_village_postal') }}" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-md-12">
                                            ...
                                            <textarea class="form-control form-control-sm" id="address_street" name="address_street" rows="3" required>{{ $user->address_street, old('address_street') }}</textarea>
                                        </div>
                                    </div>
                ...
                $.ajax({
                    ...
                    success     : function(result){
                        ...
                        if(result['length'] == 0){
                            ...
                            console.log('Data di table cities kosong');
                            ...
                            $.ajax({
                                ...
                                success     : function(result){
                                    ...
                                    console.log('Data yang didapat dari API Server(RajaOngkir): ');
                                    console.log(result);
                                }
                            });
                        }else{
                            // display data di console browser untuk check result
                            console.log('Data sudah ada di table cities. Tidak perlu ambil dari API(RajaOngkir)');
